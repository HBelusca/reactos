    ...
    _In_ ULONG ExpectedConfigurationDataLength)
{
    ...
    {
        DPRINT_TRACE("IsLegacyConfigData:FALSE - ConfigurationData == NULL\n");
        return FALSE;
    }
    ...
    {
        DPRINT_TRACE("IsLegacyConfigData:FALSE - ConfigurationDataLength == %lu\n",
    ...
    {
        DPRINT_TRACE("IsLegacyConfigData:FALSE - Version %lu, Revision %lu\n",
                ResourceList->Version, ResourceList->Revision);
        return FALSE;
    }

    DPRINT_TRACE("IsLegacyConfigData:TRUE\n");
    return TRUE;
}
    ...
    _In_ ULONG ExpectedConfigurationDataLength)
{
    if (!ConfigurationData)
    {
        DPRINT_TRACE("IsLegacyConfigDataFull:FALSE - ConfigurationData == NULL\n");
        return FALSE;
    }
    ...
    if ((ConfigurationDataLength < FIELD_OFFSET(CM_FULL_RESOURCE_DESCRIPTOR,
        ...
        (ConfigurationDataLength != ExpectedConfigurationDataLength))
    {
        DPRINT_TRACE("IsLegacyConfigDataFull:FALSE - ConfigurationDataLength == %lu\n",
                ConfigurationDataLength);
        return FALSE;
    }
    ...
    _In_ ULONG ConfigurationDataLength)
{
    if (!ConfigurationData)
    {
        DPRINT_TRACE("IsNewConfigDataFull:FALSE - ConfigurationData == NULL\n");
        return FALSE;
    }
    ...
    {
        DPRINT_TRACE("IsNewConfigDataFull:FALSE - ConfigurationDataLength == %lu\n",
                ConfigurationDataLength);
        return FALSE;
    }
