...
OFFSET(PcRspBase, KPCR, Prcb.RspBase),
//OFFSET(PcPrcbLock, KPCR, PrcbLock),
OFFSET(PcSetMember, KPCR, Prcb.SetMember), // not Win 10
#if 0
OFFSET(PcCr0, KPCR, Prcb.Cr0),
OFFSET(PcCr2, KPCR, Prcb.Cr2),
OFFSET(PcCr3, KPCR, Prcb.Cr3),
OFFSET(PcCr4, KPCR, Prcb.Cr4),
OFFSET(PcKernelDr0, KPCR, Prcb.KernelDr0),
OFFSET(PcKernelDr1, KPCR, Prcb.KernelDr1),
OFFSET(PcKernelDr2, KPCR, Prcb.KernelDr2),
OFFSET(PcKernelDr3, KPCR, Prcb.KernelDr3),
OFFSET(PcKernelDr7, KPCR, Prcb.KernelDr7),
OFFSET(PcGdtrLimit, KPCR, Prcb.GdtrLimit),
OFFSET(PcGdtrBase, KPCR, Prcb.GdtrBase),
...
#endif
OFFSET(PcCpuType, KPCR, Prcb.CpuType),
OFFSET(PcCpuID, KPCR, Prcb.CpuID),
OFFSET(PcCpuStep, KPCR, Prcb.CpuStep),
OFFSET(PcCpuVendor, KPCR, Prcb.CpuVendor),
OFFSET(PcCFlushSize, KPCR, Prcb.CFlushSize),
OFFSET(PcDeferredReadyListHead, KPCR, Prcb.DeferredReadyListHead),
OFFSET(PcSystemCalls, KPCR, Prcb.KeSystemCalls),
OFFSET(PcDpcRoutineActive, KPCR, Prcb.DpcRoutineActive),
OFFSET(PcInterruptCount, KPCR, Prcb.InterruptCount),
OFFSET(PcDebuggerSavedIRQL, KPCR, Prcb.DebuggerSavedIRQL),
OFFSET(PcTickOffset, KPCR, Prcb.TickOffset), // not Win 10
OFFSET(PcMasterOffset, KPCR, Prcb.MasterOffset),
OFFSET(PcSkipTick, KPCR, Prcb.SkipTick), // not Win 10
#if (NTDDI_VERSION >= NTDDI_LONGHORN)
OFFSET(PcVirtualApicAssist, KPCR, Prcb.VirtualApicAssist),
OFFSET(PcStartCycles, KPCR, Prcb.StartCycles),
#endif
//OFFSET(PcFeatureBits, KPCR, Prcb.FeatureBits),
//OFFSET(PcNmiActive, KPCR, Prcb.NmiActive),
//OFFSET(PcDeepSleep, KPCR, Prcb.DeepSleep),
//OFFSET(PcSfCode equ 066A8H, KPCR, Prcb.SfCode),
//OFFSET(PcSfVa equ 066B0H, KPCR, Prcb.SfVa),
