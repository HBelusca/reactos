...
HEADER("KPCR offsets"),
OFFSET(PcExceptionList, KPCR, NtTib.ExceptionList),
//OFFSET(PcInitialStack, KPCR, InitialStack),
//OFFSET(PcMxCsr, KPCR, MxCsr),
OFFSET(PcTssCopy, KPCR, TssCopy),
OFFSET(PcContextSwitches, KPCR, ContextSwitches),
OFFSET(PcSetMemberCopy, KPCR, SetMemberCopy),
OFFSET(PcTeb, KPCR, NtTib.Self),
OFFSET(PcSelfPcr, KPCR, SelfPcr),
OFFSET(PcPrcb, KPCR, Prcb),
OFFSET(PcIrql, KPCR, Irql),
OFFSET(PcIRR, KPCR, IRR),
OFFSET(PcIrrActive, KPCR, IrrActive),
OFFSET(PcIDR, KPCR, IDR),
...
OFFSET(PcVdmAlert, KPCR, VdmAlert),
OFFSET(PcHal, KPCR, HalReserved),
OFFSET(PcPrcbData, KPCR, PrcbData),
OFFSET(PcCurrentThread, KPCR, PrcbData.CurrentThread),
//OFFSET(PcNestingLevel, KPCR, PrcbData.NestingLevel),
OFFSET(PcParentNode, KPCR, PrcbData.ParentNode),
OFFSET(PcInterruptCount, KPCR, PrcbData.InterruptCount),
//OFFSET(PcDpcRequestSummary, KPCR, PrcbData.DpcRequestSummary),
//OFFSET(PcStartCycles, KPCR, PrcbData.StartCycles),
//OFFSET(PcCycleTime, KPCR, PrcbData.CycleTime),
//OFFSET(PcHighCycleTime, KPCR, PrcbData.HighCycleTime),
...
OFFSET(KPCR_PERF_GLOBAL_GROUP_MASK, KPCR, PerfGlobalGroupMask),
OFFSET(KPCR_CONTEXT_SWITCHES, KPCR, ContextSwitches),
OFFSET(KPCR_TEB, KPCR, Used_Self),
OFFSET(KPCR_SELF, KPCR, SelfPcr),
OFFSET(KPCR_PRCB, KPCR, Prcb),
OFFSET(KPCR_IDT, KPCR, IDT),
OFFSET(KPCR_GDT, KPCR, GDT),
OFFSET(KPCR_TSS, KPCR, TSS),
OFFSET(KPCR_STALL_SCALE_FACTOR, KPCR, StallScaleFactor),
OFFSET(KPCR_PRCB_DATA, KPCR, PrcbData),
OFFSET(KPCR_CURRENT_THREAD, KPCR, PrcbData.CurrentThread),
OFFSET(KPCR_PRCB_NEXT_THREAD, KPCR, PrcbData.NextThread),
OFFSET(KPCR_PRCB_DPC_QUEUE_DEPTH, KPCR, PrcbData.DpcData[0].DpcQueueDepth),
OFFSET(KPCR_PRCB_DPC_STACK, KPCR, PrcbData.DpcStack),
OFFSET(KPCR_PRCB_MAXIMUM_DPC_QUEUE_DEPTH, KPCR, PrcbData.MaximumDpcQueueDepth),
OFFSET(KPCR_PRCB_DPC_ROUTINE_ACTIVE, KPCR, PrcbData.DpcRoutineActive),
OFFSET(KPCR_PRCB_TIMER_REQUEST, KPCR, PrcbData.TimerRequest),
OFFSET(KPCR_PRCB_QUANTUM_END, KPCR, PrcbData.QuantumEnd),
OFFSET(KPCR_PRCB_DEFERRED_READY_LIST_HEAD, KPCR, PrcbData.DeferredReadyListHead),
OFFSET(KPCR_PRCB_POWER_STATE_IDLE_FUNCTION, KPCR, PrcbData.PowerState.IdleFunction),
