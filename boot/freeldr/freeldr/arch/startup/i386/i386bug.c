...
#define MachVideoPutChar PcVideoPutChar
VOID PcVideoHideShowTextCursor(BOOLEAN Show);
#define MachVideoHideShowTextCursor PcVideoHideShowTextCursor
VOID PcVideoClearScreen(UCHAR Attr);
#define MachVideoClearScreen PcVideoClearScreen
...
#if 0 // No bugchecks in StartUp Module for now...
