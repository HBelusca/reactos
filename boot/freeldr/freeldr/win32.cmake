...
list(APPEND WIN32LDR_NTLDR_SOURCE
    ntldr/advopts.c
    ntldr/inffile.c
    ntldr/ntldropts.c)
...
add_library(win32freeldr_common
    ...
    ${WIN32LDR_NTLDR_SOURCE})

target_compile_definitions(win32freeldr_common PRIVATE _FRLDRLIB_ MY_WIN32)
...
if(STACK_PROTECTOR)
    target_link_libraries(win32ldr gcc_ssp_nt)
endif()
