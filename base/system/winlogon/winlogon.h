...
typedef BOOL (*PLOGON_INITIALIZE)(struct _WLSESSION*);
typedef VOID (*PLOGON_PROCESS_EVENTS)(struct _WLSESSION*);
typedef LRESULT (*PLOGON_POST_MESSAGE)(struct _WLSESSION*, UINT, WPARAM, LPARAM);
typedef LRESULT (*PLOGON_SEND_MESSAGE)(struct _WLSESSION*, UINT, WPARAM, LPARAM);

typedef struct _LOGON_UI
{
    PLOGON_INITIALIZE Initialize;
    PLOGON_PROCESS_EVENTS ProcessEvents;
    PLOGON_POST_MESSAGE PostMessage;
    PLOGON_SEND_MESSAGE SendMessage;
} LOGON_UI, *PLOGON_UI;
